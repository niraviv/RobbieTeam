...
void server_main(int argc, char* argv[])
{
  ...
  Targets_manager                           target_configurations_manager(env.get_target_configirations(),
                                                                          env.get_additional_target_configirations());
  ...
  Robot_location                            robot_location_a(env.get_source_configiration_a());
  Robot_location                            robot_location_b(env.get_source_configiration_b());
