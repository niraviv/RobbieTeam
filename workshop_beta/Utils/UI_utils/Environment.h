...
private:
  ...
  Reference_point       _source_configiration_a;
  Reference_point       _source_configiration_b;
  Reference_point_vec   _target_configirations;
  Reference_point_vec   _additional_target_configirations;
public:
    ...
    :_graphics(argc,argv)
  {
    ...
    _source_configiration_a = reader.read_reference_point<K> (source_configuration_a_file_name);
    
    std::string source_configuration_b_file_name = configuration.get_source_configuration_b_file_name();
    _source_configiration_b = reader.read_reference_point<K> (source_configuration_b_file_name);
    
    std::string target_configurations_file_name = configuration.get_target_configurations_file_name();
    reader.read_reference_points<K> (target_configurations_file_name, std::back_inserter(_target_configirations));

    std::string additional_target_configurations_file_name = configuration.get_additional_target_configurations_file_name();
    reader.read_reference_points<K> (additional_target_configurations_file_name, std::back_inserter(_additional_target_configirations));
  }
  ...
  Reference_point&      get_source_configiration_a() {return _source_configiration_a;}
  Reference_point&      get_source_configiration_b() {return _source_configiration_b;}
  Reference_point_vec&  get_target_configirations() {return _target_configirations;}
  Reference_point_vec&  get_additional_target_configirations () {return _additional_target_configirations;}
}; //Environment
